-- 1. Adicionar coluna para armazenar o endereço
ALTER TABLE public.vendas_bingo_fisico ADD COLUMN IF NOT EXISTS endereco_comprador TEXT;

-- 2. Atualizar a função para receber e salvar o endereço
CREATE OR REPLACE FUNCTION public.enviar_comprovante_cliente_bingo(p_codigo text, p_nome text, p_telefone text, p_endereco text, p_comprovante text)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
