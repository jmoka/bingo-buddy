-- Adiciona as colunas na tabela de configurações
ALTER TABLE public.configuracoes ADD COLUMN IF NOT EXISTS pix_name TEXT DEFAULT 'BINGO SHOW';
ALTER TABLE public.configuracoes ADD COLUMN IF NOT EXISTS pix_city TEXT DEFAULT 'SAO PAULO';

-- Atualiza a função RPC para permitir salvar esses novos campos
