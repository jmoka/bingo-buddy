-- ============================================================
-- SISTEMA DE VENDEDORES DE RIFA (consolidado 0037 + 0038)
-- ============================================================

-- Tabela de solicitações para se tornar vendedor
-- Inclui coluna endereco e policy admin com WITH CHECK corrigida
...
DROP POLICY IF EXISTS "usuario cria propria solicitacao" ON solicitacoes_vendedor;
DROP POLICY IF EXISTS "usuario cancela propria solicitacao" ON solicitacoes_vendedor;
DROP POLICY IF EXISTS "admin gerencia solicitacoes" ON solicitacoes_vendedor;
...
-- Adicionar colunas em vendedores_rifa
...
-- Adicionar configurações de vendedor em configuracoes
