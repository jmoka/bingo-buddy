  ...
  return (
    <div className="card-container mb-6">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-xs text-muted-foreground">{commentsCount} mensagens</span>
      </div>

      <div className="rounded-xl border bg-muted/20 p-3 h-64 overflow-y-auto space-y-2">
        {isLoading && (
